Shader "Custom/Shader4"
{
    ...
    SubShader
    {
        ...
        {
            IN.uv_NoiseTex1 += _MovementDirection * _Time.y / 2.0;
            IN.uv_NoiseTex2 += _MovementDirection * _Time.y / -2.0;
            IN.uv_MainTex += _MovementDirection * _Time.y;
            IN.uv_Normal += _MovementDirection * _Time.y / 2.0;

            alphaPixel = tex2D (_NoiseTex1, IN.uv_NoiseTex1) + tex2D(_NoiseTex2, IN.uv_NoiseTex2);
